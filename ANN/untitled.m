...
figure(1)
p1 = plot(alpha1_water, d2f01_water, alpha2_water, d2f02_water, alpha3_water, d2f03_water); hold on
...
p2 = plot(alpha1_water, d2f01_water_ANN, alpha2_water, d2f02_water_ANN, alpha3_water, d2f03_water_ANN);
...
p3 = plot(alpha1_EO, d2f01_EO, alpha2_EO, d2f02_EO, alpha3_EO, d2f03_EO);
...
p4 = plot(alpha1_EO, d2f01_EO_ANN, alpha2_EO, d2f02_EO_ANN, alpha3_EO, d2f03_EO_ANN);
...
xlim([min(alpha3_water)  max(alpha3_water)])


figure(2)
p10 = plot(alpha1_water, dg01_water, alpha2_water, dg02_water, alpha3_water, dg03_water); hold on
...
p11 = plot(alpha1_water, dg01_water_ANN, alpha2_water, dg02_water_ANN, alpha3_water, dg03_water_ANN);
...
p12 = plot(alpha1_EO, dg01_EO, alpha2_EO, dg02_EO, alpha3_EO, dg03_EO);
...
p13 = plot(alpha1_EO, dg01_EO_ANN, alpha2_EO, dg02_EO_ANN, alpha3_EO, dg03_EO_ANN);
...
figure(3)
p19 = plot(alpha1_water, -dtheta01_water, alpha2_water, -dtheta02_water, alpha3_water, -dtheta03_water); hold on
...
p20 = plot(alpha1_water, -dtheta01_water_ANN, alpha2_water, -dtheta02_water_ANN, alpha3_water, -dtheta03_water_ANN); hold on
...
p21 = plot(alpha1_EO, -dtheta01_EO, alpha2_EO, -dtheta02_EO, alpha3_EO, -dtheta03_EO);
...
p22 = plot(alpha1_EO, -dtheta01_EO_ANN, alpha2_EO, -dtheta02_EO_ANN, alpha3_EO, -dtheta03_EO_ANN); 
